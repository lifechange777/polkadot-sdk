...
use crate::{ProofsKey, ProofsStorage, ProofsValue};
...
impl VerifyProof for AssetHubAccountProver {
	...
	fn query_voting_power_for(
		...
		Some(VotingPower { account_power: account_balance.data.free, total: total_issuance })
	}
}
...
pub struct AssetHubStateRootProvider;
impl ProvideHash for AssetHubStateRootProvider {
