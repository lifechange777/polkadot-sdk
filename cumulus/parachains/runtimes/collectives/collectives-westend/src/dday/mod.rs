...
impl pallet_proofs_voting::Config<DDayVotingInstance> for Runtime {
	...
	// TODO: FAIL-CI - we have `Balances::total_issuance` as a part of every proof dynamically? TotalIssuanceOf<Balances?
	// `Balances::total_issuance` on th state-proof supported chain.
	type MaxTurnout = ConstU128<1_000_000_000_000>;
...
impl pallet_referenda::Config<DDayReferendaInstance> for Runtime {
	...
	// TODO: FAIL-CI nothing? Collect failed voting and send XCM at the end to unstalled chain?
	type Slash = ();
